...
void SimpleLightingOWgt::paintGL()
{
    ...
    shaderProgram_.setUniformValue("light.position",gLightPos);
    shaderProgram_.setUniformValue("viewPos",camera_.getPosition());

    shaderProgram_.setUniformValue("material.shininess", 32.0f);
    shaderProgram_.setUniformValue("light.position", camera_.getPosition());
    shaderProgram_.setUniformValue("light.direction", camera_.getFront());
    shaderProgram_.setUniformValue("light.cutOff", static_cast<float>(cos(12.5f * M_PI / 180)));
    shaderProgram_.setUniformValue("light.outerCutOff", (float)cos(17.5f * M_PI / 180));
    ...
    shaderProgram_.setUniformValue("light.constant", 1.0f);
    shaderProgram_.setUniformValue("light.linear", 0.09f);
    shaderProgram_.setUniformValue("light.quadratic", 0.032f);
