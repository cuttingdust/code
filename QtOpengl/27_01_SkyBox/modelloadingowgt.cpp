...
void ModelLoadingOWgt::drawObject() {
    ...
    {
        drawVegetationShaderProgram(projection, view);
    ...
    if (skybox_ && bOpenSkyBox_)
    {
        ...
        skyBoxShaderProgram_.setUniformValue("projection", projection);
        skyBoxShaderProgram_.setUniformValue("view", skyboxView);
...
void ModelLoadingOWgt::drawOutlineShaderProgram(QMatrix4x4 projection, QMatrix4x4 view) {
    outlineShaderProgram_.bind();
    outlineShaderProgram_.setUniformValue("projection", projection);
    outlineShaderProgram_.setUniformValue("view", view);
    outlineShaderProgram_.release();
}
...
void ModelLoadingOWgt::drawVegetationShaderProgram(QMatrix4x4 projection, QMatrix4x4 view) {
    vegetationShaderProgram_.bind();
    vegetationShaderProgram_.setUniformValue("projection", projection);
    vegetationShaderProgram_.setUniformValue("view", view);
...
void ModelLoadingOWgt::drawWindowsShaderProgram(QMatrix4x4 projection, QMatrix4x4 view) {
    windowsShaderProgram_.bind();
    windowsShaderProgram_.setUniformValue("projection", projection);
    windowsShaderProgram_.setUniformValue("view", view);
...
void ModelLoadingOWgt::drawrReflectionShaderProgram(QMatrix4x4 projection, QMatrix4x4 view) {
    reflectionShaderProgram_.bind();
    reflectionShaderProgram_.setUniformValue("projection", projection);
    reflectionShaderProgram_.setUniformValue("view", view);
