...
void SimpleLightingOWgt::paintGL()
{
    ...
    gLightColor.setX(sin(time/100 * 2.0f));
    gLightColor.setY(sin(time/100 * 0.7f));
    gLightColor.setZ(sin(time/100 * 1.3f));
    ...
    shaderProgram_.setUniformValue("material.ambient", 1.0f, 0.5f, 0.31f);
    shaderProgram_.setUniformValue("material.diffuse", 1.0f, 0.5f, 0.31f);
    shaderProgram_.setUniformValue("material.specular", 0.5f, 0.5f, 0.5f);
    shaderProgram_.setUniformValue("material.shininess", 32.0f);

    shaderProgram_.setUniformValue("light.ambient", ambientColor);
    shaderProgram_.setUniformValue("light.diffuse", diffuseColor);
    shaderProgram_.setUniformValue("light.specular", QVector3D(1.0,1.0,1.0));
