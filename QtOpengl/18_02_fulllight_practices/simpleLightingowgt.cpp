...
void SimpleLightingOWgt::paintGL()
{
    ...
    shaderProgram_.setUniformValue("dirLight.ambient", 0.0f, 0.0f, 0.0f);
    shaderProgram_.setUniformValue("dirLight.diffuse", 0.05f, 0.05f, 0.05);
    shaderProgram_.setUniformValue("dirLight.specular", 0.2f, 0.2f, 0.2f);
