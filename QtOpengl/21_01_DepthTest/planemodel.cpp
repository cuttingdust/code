...
//    auto diffuseTexture = new QOpenGLTexture(QImage(":/image/texMap/container2.png").mirrored());
    auto diffuseTexture = new QOpenGLTexture(QImage(":/image/texMap/container2_specular.png").mirrored());
    auto specularTexture = new QOpenGLTexture(QImage(":/image/texMap/container2_specular.png").mirrored());
