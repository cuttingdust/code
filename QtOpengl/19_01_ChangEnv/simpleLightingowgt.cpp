...
EnvironmentType SimpleLightingOWgt::getViewEnvType() const {
    return viewEnvType_;
}

void SimpleLightingOWgt::setViewEnvType(EnvironmentType viewEnvType) {
    viewEnvType_ = viewEnvType;
}

void SimpleLightingOWgt::setEnvSettingType(EnvironmentType type) {
    setViewEnvType(type);
    switch (type) {
