...
void SimpleLightingOWgt::paintGL()
{
    ...
    shaderProgram_.setUniformValue("material.ambient", 0.0f, 0.1f, 0.06f);
    shaderProgram_.setUniformValue("material.diffuse", 0.0f, 0.50980392f, 0.50980392f);
    shaderProgram_.setUniformValue("material.specular", 0.50196078f, 0.50196078f, 0.50196078f);
