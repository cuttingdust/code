    ...
    , ui_(new Ui::MainWindow)
{
    ...
    connect(ui_->actionDeferedDraw, SIGNAL(triggered()), this, SLOT(slotDeferedRender()));
    connect(ui_->actionSSAO, SIGNAL(triggered()), this, SLOT(slotDrawSSAO()));
...
void MainWindow::slotDeferedRender() {
    auto bDefered = ui_->openGLWidget->isBDeferedRender();
    ui_->openGLWidget->setBDeferedRender(!bDefered);
}

void MainWindow::slotDrawSSAO() {
    auto bSSAO = ui_->openGLWidget->isBDrawSsao();
    ui_->openGLWidget->setBDrawSsao(!bSSAO);
